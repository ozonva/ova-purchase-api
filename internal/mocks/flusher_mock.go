...
func (m *MockFlusher) Flush(purchases []purchase.Purchase) []purchase.Purchase {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Flush", purchases)
	ret0, _ := ret[0].([]purchase.Purchase)
	return ret0
}

// Flush indicates an expected call of Flush.
func (mr *MockFlusherMockRecorder) Flush(purchases interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockFlusher)(nil).Flush), purchases)
}
